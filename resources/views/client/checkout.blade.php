                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                                    ...
                                    <div class="single_filter_card mb-2">
                                        <h5><a href="#categories" data-toggle="collapse" class="collapsed"
                                                aria-expanded="false" role="button">Chọn danh mục<i
                                    ...
                                    <form method="GET" action="{{ route('danhmucsp') }}">
                                        <div class="text-left">
                                            @foreach ($colors as $color)
                                                <div class="form-check form-option form-check-inline mb-2">
                                                    <input class="form-check-input" type="radio" name="size"
                                                        id="size{{ $color->id }}" value="{{ $color->id }}"
                                                        {{ request('size') == $size->id ? 'checked' : '' }}
                                                        onchange="this.form.submit()">
                                                    <label class="form-option-label"
                                                        for="size{{ $color->id }}">{{ $color->name }}</label>
                                                </div>
                                            @endforeach
                                        </div>
                                    </form>
