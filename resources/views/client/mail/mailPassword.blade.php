...
<body
    style="width: 100%; min-height: 600px; background-color: #dbdde4; font-size: 18px; font-family: Arial, sans-serif;">
    ...
    <div
        ...
        <p>Chào bạn,</p>
        <p>Chúng tôi đã nhận được yêu cầu đặt lại mật khẩu cho tài khoản của bạn. Mã OTP để
            đặt lại mật khẩu của bạn là <b>{{ $otp }}</b></p>
