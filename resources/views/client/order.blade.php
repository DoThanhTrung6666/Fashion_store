                    ...
                    <div class="order-card">
                        <div class="shop-info">
                            ...
                            <div class="shop-actions">
                                ...
                                <span class="discounted-price">Ngày đặt hàng : {{\Carbon\Carbon::parse($order->order_date)->format('d/m/Y')}}</span>
                            </div>
                        </div>
                        ...
                        @foreach ($order->orderItems as $item)
                            <div class="order-info">
                                ...
                                <div class="product-details">
                                    ...
                                    <p class="product-variant">Phân loại hàng: Màu {{ $item->productVariant->color->name }} , Kích cỡ {{$item->productVariant->size->name}}</p>
                                    <p class="product-quantity">Số lượng : {{ $item->quantity }}x</p>
                                </div>
                                <div class="product-price">
                                    <span class="original-price">{{ number_format($item->productVariant->product->price, 0, ',', '.') }}đ</span>
                                    <span class="discounted-price">{{ number_format($item->productVariant->product->price, 0, ',', '.') }}đ</span>
                                </div>
                            </div>
                        @endforeach
                    ...
                    <div class="order-card">
                        ...
                        @foreach ($order->orderItems as $item)
                            <div class="order-info">
                                ...
                                <div class="product-details">
                                    <p class="product-name">{{ $item->productVariant->product->name }}</p>
                                    <p class="product-variant">Phân loại hàng: {{ $item->productVariant->color->name }}</p>
            ...
            @foreach ($orders_vanchuyen as $order)
                <div class="order-wrapper" style="margin-top: 20px">
                    <div class="order-card">
                        ...
                        <div class="order-status">
                            {{-- <span class="status-label">Giao hàng thành công</span> --}}
                            <span class="status">Đơn hàng đã được xác nhận và đang trong quá trình vận chuyển</span>
                        </div>
                        <div class="order-total">
                            <span>Thành tiền: <b>{{ number_format($order->total_amount, 0, ',', '.') }}đ</b></span>
                        </div>
                    ...
                    <div class="order-card">
                        ...
                        @foreach ($order->orderItems as $item)
                            <div class="order-info">
                                ...
                                <div class="product-price">
                                    <span class="original-price">{{ number_format($item->productVariant->price, 0, ',', '.') }}đ</span>
